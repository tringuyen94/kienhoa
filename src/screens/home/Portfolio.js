   ...
   return (
      <Grid container justifyContent="center" alignItems="center" spacing={2} className={classes.portfolioWrapper}>
         <Grid item xs={6} sm={4} md={3} className={classes.portfolioItem}>
            <img src={Portfolio1} alt="portfolio" width="100%" height="275px" />
         ...
         <Grid item xs={6} sm={4} md={3} className={classes.portfolioItem}>
            <img src={Portfolio2}  alt="portfolio" width="100%" height="275px" />
            <div className={classes.portfolioDetail}>
         ...
         <Grid item xs={6} sm={4} md={3} className={classes.portfolioItem}>
            <img src={Portfolio3} alt="portfolio"  width="100%" height="275px" />
            <div className={classes.portfolioDetail}>
               <h5 >Mai Hoà Bình</h5>
               <p>Ảnh thực tế sau thi công</p>
            </div>
         ...
         <Grid item xs={6} sm={4} md={3} className={classes.portfolioItem}>
            <img src={Portfolio4} alt="portfolio" width="100%" height="275px" />
            <div className={classes.portfolioDetail}>
               <h5 >Trương Tử Bửu</h5>
               <p>Ảnh thực tế sau thi công</p>
            </div>
